        ...
        <section>
            <article>
                <Pdf targetRef={ref} filename="blogs.pdf">
                    {({ toPdf }) => <button onClick={toPdf} className='mx-auto text-center flex justify-center items-center gap-2 text-white bg-green-600 hover:bg-green-500 duration-500 py-2 px-5 rounded-md my-5 md:my-10  ring-green-300 focus:ring-4'><FaFileDownload /> Download PDF</button>}
                </Pdf>
            </article>
            <article className="space-y-5" ref={ref}>
                ...
                <div className="collapse collapse-arrow bg-gray-100 text-gray-700 rounded-lg" >
                    ...
                    <div className="collapse-content text-gray-500 text-justify">
